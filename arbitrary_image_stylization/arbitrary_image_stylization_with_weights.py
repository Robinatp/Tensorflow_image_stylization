...
TF_API="/home/ubuntu/eclipse-workspace/Github/magenta/magenta/models/arbitrary_image_stylization"
    ...
    for content_i, content_img_path in enumerate(content_img_list):
      ...
      for style_i, style_img_path in enumerate(style_img_list):
        ...
        for interp_i, wi in enumerate(interpolation_weights):
          ...
          if not tf.gfile.Exists(os.path.join(FLAGS.output_dir,style_img_name)):
              tf.gfile.MkDir(os.path.join(FLAGS.output_dir,style_img_name))
